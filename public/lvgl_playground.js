...
function findWasmBinary() {
  return locateFile('lvgl_playground.wasm');
}
...
var _reset_screen,
  ...
  _helper_layer_sys,
  _helper_set_pad_all,
  _lv_obj_set_style_pad_left,
  _lv_obj_set_style_pad_right,
  _lv_obj_set_style_pad_top,
  _lv_obj_set_style_pad_bottom,
  _helper_set_pad_gap,
  _helper_set_bg_color,
  _helper_set_text_color,
  _helper_set_border_color,
  _helper_set_shadow_color,
  _helper_set_outline_color,
  _get_font_montserrat_8,
  _get_font_montserrat_10,
  _get_font_montserrat_12,
  _get_font_montserrat_14,
  _get_font_montserrat_16,
  _get_font_montserrat_18,
  _get_font_montserrat_20,
  _get_font_montserrat_22,
  _get_font_montserrat_24,
  _get_font_montserrat_28,
  _get_font_montserrat_32,
  _main,
  _lv_dropdown_create,
  _lv_dropdown_set_options,
  _lv_obj_add_state,
  _lv_obj_create,
  _lv_obj_add_flag,
  _lv_obj_remove_flag,
  _lv_obj_remove_state,
  _lv_spinner_create,
  _lv_obj_set_pos,
  _lv_arc_set_value,
  _lv_arc_create,
  _lv_arc_set_angles,
  _lv_arc_set_bg_angles,
  _lv_arc_set_range,
  _lv_switch_create,
  _lv_button_create,
  _lv_obj_set_size,
  _lv_obj_set_flex_flow,
  _lv_obj_set_flex_grow,
  _lv_label_create,
  _lv_label_set_text,
  _lv_obj_center,
  _lv_obj_set_width,
  _lv_obj_set_height,
  _lv_obj_set_style_text_align,
  _lv_obj_delete,
  _lv_obj_align_to,
  _lv_obj_align,
  _lv_obj_set_flex_align,
  _lv_bar_create,
  _lv_bar_set_value,
  _lv_bar_set_range,
  _lv_checkbox_create,
  _lv_checkbox_set_text,
  _lv_label_set_long_mode,
  _lv_slider_create,
  _lv_slider_set_value,
  _lv_slider_set_range,
  _lv_slider_get_value,
  _lv_obj_set_style_border_opa,
  _lv_obj_set_style_border_width,
  _lv_obj_set_style_shadow_width,
  _lv_obj_set_style_text_font,
  _lv_obj_set_style_text_letter_space,
  _lv_obj_set_style_text_line_space,
...
function assignWasmExports(wasmExports) {
  _reset_screen = Module['_reset_screen'] = wasmExports['reset_screen'];
  _lv_obj_clean = Module['_lv_obj_clean'] = wasmExports['lv_obj_clean'];
  _lv_obj_set_style_bg_opa = Module['_lv_obj_set_style_bg_opa'] = wasmExports['lv_obj_set_style_bg_opa'];
  _helper_scr_act = Module['_helper_scr_act'] = wasmExports['helper_scr_act'];
  _helper_layer_top = Module['_helper_layer_top'] = wasmExports['helper_layer_top'];
  _helper_layer_sys = Module['_helper_layer_sys'] = wasmExports['helper_layer_sys'];
  _helper_set_pad_all = Module['_helper_set_pad_all'] = wasmExports['helper_set_pad_all'];
  _lv_obj_set_style_pad_left = Module['_lv_obj_set_style_pad_left'] = wasmExports['lv_obj_set_style_pad_left'];
  _lv_obj_set_style_pad_right = Module['_lv_obj_set_style_pad_right'] = wasmExports['lv_obj_set_style_pad_right'];
  _lv_obj_set_style_pad_top = Module['_lv_obj_set_style_pad_top'] = wasmExports['lv_obj_set_style_pad_top'];
  _lv_obj_set_style_pad_bottom = Module['_lv_obj_set_style_pad_bottom'] = wasmExports['lv_obj_set_style_pad_bottom'];
  _helper_set_pad_gap = Module['_helper_set_pad_gap'] = wasmExports['helper_set_pad_gap'];
  _helper_set_bg_color = Module['_helper_set_bg_color'] = wasmExports['helper_set_bg_color'];
  _helper_set_text_color = Module['_helper_set_text_color'] = wasmExports['helper_set_text_color'];
  _helper_set_border_color = Module['_helper_set_border_color'] = wasmExports['helper_set_border_color'];
  _helper_set_shadow_color = Module['_helper_set_shadow_color'] = wasmExports['helper_set_shadow_color'];
  _helper_set_outline_color = Module['_helper_set_outline_color'] = wasmExports['helper_set_outline_color'];
  _get_font_montserrat_8 = Module['_get_font_montserrat_8'] = wasmExports['get_font_montserrat_8'];
  _get_font_montserrat_10 = Module['_get_font_montserrat_10'] = wasmExports['get_font_montserrat_10'];
  _get_font_montserrat_12 = Module['_get_font_montserrat_12'] = wasmExports['get_font_montserrat_12'];
  _get_font_montserrat_14 = Module['_get_font_montserrat_14'] = wasmExports['get_font_montserrat_14'];
  _get_font_montserrat_16 = Module['_get_font_montserrat_16'] = wasmExports['get_font_montserrat_16'];
  _get_font_montserrat_18 = Module['_get_font_montserrat_18'] = wasmExports['get_font_montserrat_18'];
  _get_font_montserrat_20 = Module['_get_font_montserrat_20'] = wasmExports['get_font_montserrat_20'];
  _get_font_montserrat_22 = Module['_get_font_montserrat_22'] = wasmExports['get_font_montserrat_22'];
  _get_font_montserrat_24 = Module['_get_font_montserrat_24'] = wasmExports['get_font_montserrat_24'];
  _get_font_montserrat_28 = Module['_get_font_montserrat_28'] = wasmExports['get_font_montserrat_28'];
  _get_font_montserrat_32 = Module['_get_font_montserrat_32'] = wasmExports['get_font_montserrat_32'];
  _main = Module['_main'] = wasmExports['main'];
  _lv_dropdown_create = Module['_lv_dropdown_create'] = wasmExports['lv_dropdown_create'];
  _lv_dropdown_set_options = Module['_lv_dropdown_set_options'] = wasmExports['lv_dropdown_set_options'];
  _lv_obj_add_state = Module['_lv_obj_add_state'] = wasmExports['lv_obj_add_state'];
  _lv_obj_create = Module['_lv_obj_create'] = wasmExports['lv_obj_create'];
  _lv_obj_add_flag = Module['_lv_obj_add_flag'] = wasmExports['lv_obj_add_flag'];
  _lv_obj_remove_flag = Module['_lv_obj_remove_flag'] = wasmExports['lv_obj_remove_flag'];
  _lv_obj_remove_state = Module['_lv_obj_remove_state'] = wasmExports['lv_obj_remove_state'];
  _lv_spinner_create = Module['_lv_spinner_create'] = wasmExports['lv_spinner_create'];
  _lv_obj_set_pos = Module['_lv_obj_set_pos'] = wasmExports['lv_obj_set_pos'];
  _lv_arc_set_value = Module['_lv_arc_set_value'] = wasmExports['lv_arc_set_value'];
  _lv_arc_create = Module['_lv_arc_create'] = wasmExports['lv_arc_create'];
  _lv_arc_set_angles = Module['_lv_arc_set_angles'] = wasmExports['lv_arc_set_angles'];
  _lv_arc_set_bg_angles = Module['_lv_arc_set_bg_angles'] = wasmExports['lv_arc_set_bg_angles'];
  _lv_arc_set_range = Module['_lv_arc_set_range'] = wasmExports['lv_arc_set_range'];
  _lv_switch_create = Module['_lv_switch_create'] = wasmExports['lv_switch_create'];
  _lv_button_create = Module['_lv_button_create'] = wasmExports['lv_button_create'];
  _lv_obj_set_size = Module['_lv_obj_set_size'] = wasmExports['lv_obj_set_size'];
  _lv_obj_set_flex_flow = Module['_lv_obj_set_flex_flow'] = wasmExports['lv_obj_set_flex_flow'];
  _lv_obj_set_flex_grow = Module['_lv_obj_set_flex_grow'] = wasmExports['lv_obj_set_flex_grow'];
  _lv_label_create = Module['_lv_label_create'] = wasmExports['lv_label_create'];
  _lv_label_set_text = Module['_lv_label_set_text'] = wasmExports['lv_label_set_text'];
  _lv_obj_center = Module['_lv_obj_center'] = wasmExports['lv_obj_center'];
  _lv_obj_set_width = Module['_lv_obj_set_width'] = wasmExports['lv_obj_set_width'];
  _lv_obj_set_height = Module['_lv_obj_set_height'] = wasmExports['lv_obj_set_height'];
  _lv_obj_set_style_text_align = Module['_lv_obj_set_style_text_align'] = wasmExports['lv_obj_set_style_text_align'];
  _lv_obj_delete = Module['_lv_obj_delete'] = wasmExports['lv_obj_delete'];
  _lv_obj_align_to = Module['_lv_obj_align_to'] = wasmExports['lv_obj_align_to'];
  _lv_obj_align = Module['_lv_obj_align'] = wasmExports['lv_obj_align'];
  _lv_obj_set_flex_align = Module['_lv_obj_set_flex_align'] = wasmExports['lv_obj_set_flex_align'];
  _lv_bar_create = Module['_lv_bar_create'] = wasmExports['lv_bar_create'];
  _lv_bar_set_value = Module['_lv_bar_set_value'] = wasmExports['lv_bar_set_value'];
  _lv_bar_set_range = Module['_lv_bar_set_range'] = wasmExports['lv_bar_set_range'];
  _lv_checkbox_create = Module['_lv_checkbox_create'] = wasmExports['lv_checkbox_create'];
  _lv_checkbox_set_text = Module['_lv_checkbox_set_text'] = wasmExports['lv_checkbox_set_text'];
  _lv_label_set_long_mode = Module['_lv_label_set_long_mode'] = wasmExports['lv_label_set_long_mode'];
  _lv_slider_create = Module['_lv_slider_create'] = wasmExports['lv_slider_create'];
  _lv_slider_set_value = Module['_lv_slider_set_value'] = wasmExports['lv_slider_set_value'];
  _lv_slider_set_range = Module['_lv_slider_set_range'] = wasmExports['lv_slider_set_range'];
  _lv_slider_get_value = Module['_lv_slider_get_value'] = wasmExports['lv_slider_get_value'];
  _lv_obj_set_style_border_opa = Module['_lv_obj_set_style_border_opa'] = wasmExports['lv_obj_set_style_border_opa'];
  _lv_obj_set_style_border_width = Module['_lv_obj_set_style_border_width'] = wasmExports['lv_obj_set_style_border_width'];
  _lv_obj_set_style_shadow_width = Module['_lv_obj_set_style_shadow_width'] = wasmExports['lv_obj_set_style_shadow_width'];
  _lv_obj_set_style_text_font = Module['_lv_obj_set_style_text_font'] = wasmExports['lv_obj_set_style_text_font'];
  _lv_obj_set_style_text_letter_space = Module['_lv_obj_set_style_text_letter_space'] = wasmExports['lv_obj_set_style_text_letter_space'];
  _lv_obj_set_style_text_line_space = Module['_lv_obj_set_style_text_line_space'] = wasmExports['lv_obj_set_style_text_line_space'];
  _lv_obj_set_style_radius = Module['_lv_obj_set_style_radius'] = wasmExports['lv_obj_set_style_radius'];
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createLvglModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createLvglModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createLvglModule);
